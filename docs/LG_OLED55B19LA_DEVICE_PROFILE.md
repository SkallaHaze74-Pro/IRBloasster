...
SmartIR 1.1.5 bietet dafür direkte webOS-Schaltflächen. Zusätzlich wird die vom Fernseher selbst gelieferte Eingangsliste angezeigt, damit abweichende Namen oder IDs erkannt werden können.
...
MAC-Adresse, IP, Client-Key und Zertifikat-Fingerabdruck werden bei Verwendung ausschließlich lokal in der App gespeichert. Der Client-Key wird über den Android Keystore verschlüsselt.
